...
import 'package:viensdindin/src/blocs/bloc_event.dart';
import 'package:viensdindin/src/blocs/bloc_state.dart';
import 'package:viensdindin/src/blocs/movie_details_bloc.dart';
import 'package:viensdindin/src/repositories/http_client.dart';
import 'package:viensdindin/src/repositories/repositories.dart';
import 'package:viensdindin/src/ui/home/home_movie_scroll_row.dart';
import 'package:viensdindin/src/ui/video_player/video_player.dart';
import '../../models/models.dart';
import '../../blocs/related_movies/bloc.dart';

class MoviePageArguments {
  static final routeName = "Films";
  final Movie movie;
        ...
        child: Row(
            ...
            children: <Widget>[
              Column(children: <Widget>[
                ...
                Text('Mes list', style: TextStyle(fontSize: 12)),
              ]),
              SizedBox(
                  width: 100,
                  height: 100,
                    ...
                    onPressed: () {
                      ...
                      if (currentState is BlocStateLoading) {
                        _showAlertDialog(context,
                            title: 'Loading',
                            message:'Le contenu du film est en cours de chargement. Veuillez réessayer plus tard.');
                      }
                      ...
                      if (currentState is BlocStateLoaded) {
                        ...
                        if (theMovie.videoResources.isNotEmpty &&
                          ...
                          _showAlertDialog(context,
                              title: 'Erreur',
                              message: 'Erreur lors du chargement de la ressource de film.');
                        }
                      }
                    },
      ...
      return Column(children: <Widget>[
        Align(
          ...
          child: Padding(
            ...
            child: Text('Tu pourrais aussi aimer',
